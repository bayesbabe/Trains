#Script to identify if there is a train in an image produced by camera on deck and saved on local machine
#update to use ORB feature detection between to images instead of color differences
